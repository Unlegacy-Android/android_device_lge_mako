...
/dev/block/platform/msm_sdcc.1/by-name/userdata     /data           f2fs    noatime,nosuid,nodev,inline_xattr                               wait,check,encryptable=/dev/block/platform/msm_sdcc.1/by-name/metadata
